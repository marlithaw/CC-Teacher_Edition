(() => {
  ...
  const systems = [
    ...
    },
    {
      ...
      shortTitle: "Student Technology · 5–8 Only",
      status: "Grades 5–8 only",
      statusClass: "current",
      purpose: "For Grades 5–8 only: use one schoolwide procedure for carrying, storing, checking, and lining up with student devices. Do not assign or teach this as a K–4 procedure.",
