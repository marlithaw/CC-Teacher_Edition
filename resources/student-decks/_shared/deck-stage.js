 ...
 *     content genuinely needs interactive behavior static HTML can't express.
...
(() => {
  ...
  class DeckStage extends HTMLElement {
    ...
    _fit() {
      ...
      // Overlay is centered on the viewport via left:50% + translate(-50%);
     ...
     *  back to _go's clamp-at-ends behavior (flash overlay) when there's
